...
struct PredictionInputEffect: OptionSet {
    ...
    func localizedDescription(forGlucoseUnit unit: HKUnit) -> String? {
        ...
        case [.retrospection]:
            return NSLocalizedString("15 min comparison of glucose prediction vs actual, continued with decay over 30 min", comment: "Description of the prediction input effect for retrospective correction")
        default:
            return nil
        }
    }
