...
final class LoopDataManager {
    ...
    private func checkAlerts() {
        ...
        if let glucose = predictedGlucose {
            ...
            // Low Glucose 30 minute alarm @ 80 mg/dl
            ...
            // High glucose 20 minute alarm at 180
            let highAlertThreshold = GlucoseThreshold (unit: HKUnit.milligramsPerDeciliter(), value:180)
            if let nextHourMaxGlucose = (glucose.filter { $0.startDate <= Date().addingTimeInterval(20*60) }.last) {
